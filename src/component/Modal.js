...
function CustomModal(props) {
  const {
    ...
    onClose,
    handleChange,
    handleChangeInputBedrooms,
    handleChangeInputBathrooms,
    handleChangeInputCar,
    handleChangeImage,
    percentUploaded,
    sendFile,
    errorPicture,
  ...
  if (errorPicture) {
    errors.errorPicture = errorPicture;
  } else {
    delete errors.errorPicture;
  }
    ...
    <>
      ...
      >
        ...
        <ModalContent m="0 auto" transform="translateY(-50%)" top="50%">
          <ModalHeader fontWeight="500" pb="5px">
            Create your offer
          </ModalHeader>
          <ModalCloseButton
            ...
            <Flex>
              <FormControl w="100px" mt={4}>
                ...
                <NumberInput
                  ...
                  max={20}
                  borderColor="rgb(226, 232, 240)"
                  onChange={handleChangeInputBedrooms}
                >
              ...
              <FormControl w="100px" m="1rem 2rem 0">
                ...
                <NumberInput
                  ...
                  max={20}
                  borderColor="rgb(226, 232, 240)"
                  onChange={handleChangeInputBathrooms}
                >
                  <NumberInputField />
                  <NumberInputStepper borderColor="rgb(226, 232, 240)">
                    <NumberIncrementStepper />

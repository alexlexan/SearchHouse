  ...
  render() {
    ...
    return (
      <PseudoBox
        ...
        border={`${
          activeProperty === property ? "1px solid #2196f3" : "1px solid #ccc"
        }`}
        ref={this.setRefCard}
        id={`card-0${index}`}
      ...
      >
        <Image
          ...
          maxH="10em"
        />
        <Box fontWeight="700" mt="5px" fontSize="16px">
          {priceFormat(price)}
        </Box>
        <Box className="details">
          <Flex justify="space-between" fontSize="14px" mt="8px">
            ...
            <Box
              color="#fff"
              background={`${activeProperty === property ? "#2196f3" : "#ccc"}`}
              h="15px"
              p="5px 10px"
            >
              {index + 1}
          ...
          <Flex className="features" fontSize="14px" m="8px 0">
            <Box className="icon-bed" pl="24px" mr="10px">
              {bedrooms}
            </Box>
            <Box className="icon-bath" pl="24px" mr="10px">
              {bathrooms}
            </Box>
            <Box className="icon-car" pl="24px" mr="10px">
              {carSpaces}
            </Box>
          </Flex>
        </Box>

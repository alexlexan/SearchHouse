import {LOADING_DATA_SUCCESS,OPEN_MODAL_CREATE_PROPERTY,CLOSE_MODAL_CREATE_PROPERTY,FILTER_CHANGED,SET_FILTERED_PROPERTIES,UPDATE_PROPERTY,
    OPEN_MODAL_FILTER,CLOSE_MAP,CLOSE_MODAL_FILTER,CLEAR_FILTER_ACTION,OPEN_MAP,SET_ACTIVE_CARD,SET_ACTIVE_INFO_WINDOW,DELETE_ACTIVE_INFO_WINDOW} from '../actions/actionTypes'
    ...
    switch (action.type) {
        ...
        case SET_FILTERED_PROPERTIES:
            return {
                ...
                activeProperty: action.getFilteredProperties(action.properties)[0] || action.properties[0],
